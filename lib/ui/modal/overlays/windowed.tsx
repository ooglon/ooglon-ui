...
const useStyles = makeStyles(({ themeb }, props: { centered: boolean }) => ({
  container: {
    ...
    margin: 16,
    minWidth: Math.min(
      Dimensions.get("window").width - themeb.spacing("md") * 4,
      380
    ),
    maxWidth: Dimensions.get("window").width - themeb.spacing("md") * 4,
